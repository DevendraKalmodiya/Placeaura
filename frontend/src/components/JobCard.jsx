        ...
        <div className="p-6">
          ...
          <div className="flex justify-between items-start mb-4 gap-4">
            ...
            <div className="flex flex-col">
              ...
              <p className="text-blue-600 font-bold text-xl mt-1.5">
                {job.company}
              </p>
              {job.external_apply_url?.includes("adzuna") && (
            ...
            {job.match_percentage && job.match_percentage !== "0%" && (
              <div
                className={`text-sm font-extrabold px-5 py-2.5 rounded-full border shadow-sm flex items-center justify-center whitespace-nowrap ${colorClasses}`}
              >
          ...
          <div className="relative bg-white w-[95%] md:w-[75%] max-w-6xl max-h-[92vh] rounded-2xl shadow-3xl flex flex-col z-10 overflow-hidden border border-gray-100">
            ...
            <div className="px-9 py-7 border-b border-gray-100 flex justify-between items-start bg-gray-50 z-10">
              <div>
                <div className="flex items-center gap-4 mb-2">
                  ...
                  {job.match_percentage && job.match_percentage !== "0%" && (
                    <span
                      className={`text-xs font-extrabold px-3 py-1.5 rounded-full border border-green-200 whitespace-nowrap bg-green-50 text-green-700`}
                    >
                      {job.match_percentage} Match
                    </span>
                  )}
            ...
            <div className="px-9 py-8 overflow-y-auto bg-white flex-1 space-y-9">
              <div className="flex flex-wrap gap-4">
                <span className="bg-white text-gray-700 text-sm font-bold px-4 py-2 rounded-lg border border-gray-100 shadow-sm">
                  📍 {job.location}
                </span>
                {job.employment_type && (
                  <span className="bg-white text-purple-700 text-sm font-bold px-4 py-2 rounded-lg border border-gray-100 shadow-sm">
                    💼 {job.employment_type}
                  </span>
                )}
                {job.salary && (
                  <span className="bg-white text-yellow-700 text-sm font-bold px-4 py-2 rounded-lg border border-gray-100 shadow-sm">
                    💰 {job.salary}
                  </span>
                )}
              </div>
              ...
              <div className="bg-white p-7 rounded-2xl border border-gray-100 shadow-sm">
                <h3 className="text-xl font-extrabold text-gray-950 mb-4 border-b border-gray-100 pb-3">
                  About the Role
                </h3>
              ...
              {job.responsibilities && (
                <div className="bg-white p-7 rounded-2xl border border-gray-100 shadow-sm">
                  <h3 className="text-xl font-extrabold text-gray-900 mb-5 border-b border-gray-100 pb-3">
              ...
              <div className="bg-blue-50 p-7 rounded-2xl border border-blue-100 flex items-center justify-between shadow-sm">
                <div>
                  <h4 className="font-extrabold text-gray-950 text-xl">
                    AI Match Analysis
                  </h4>
                  <p className="text-gray-600 text-base mt-1.5">
                    Based on your semantic profile embeddings matching the job
                    profile.
                  </p>
                </div>
                <div
                  className={`text-lg font-extrabold px-5 py-3 rounded-xl border shadow-sm ${colorClasses}`}
                >
                  {matchString} Match
                </div>
              </div>
